        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5">
                    ...
                    $_SESSION['message']="";
                    ?>
                    <h1 class="text-center mb-4">TRASH ITEM</h1>
                    <ul class="nav justify-content-center fs-3">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="index.php">Go to List</a>
                        </li>
                    </ul>
                    <table class= "table">
                        <thead>
                        ...
                        <tr>
                            ...
                            <td><a href="restore.php?id=<?=$product['id'];?>" onclick="return confirm('Are you sure you want to delete')">Restore</a> </td>
